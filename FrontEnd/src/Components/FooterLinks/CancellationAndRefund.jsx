...
const CancellAndRefund = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto  rounded-md shadow-md">
      <h1 className="text-4xl font-bold mb-6 text-primary text-center">Cancellation and Refund Policy</h1>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Processing of Refunds</h2>
        <p>
