...
const ContactUs = () => {
  return (
    <div className="p-10 max-w-4xl m-10 bg-base-200 rounded-md shadow-2xl">
      {/* Heading */}
      <h1 className="text-4xl font-bold mb-6 text-primary">Contact Us</h1>

      {/* Contact Details */}
      <div className="mb-8">
        <p className="text-xl mb-3">You can reach us through:</p>
        <ul className="space-y-4 text-lg ml-10">
